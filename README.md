...
Personal archive of reverse engineering CTF challenges I've solved, binaries, crackmes, and assembly puzzles.
...
`ghidra` · `gdb` / `pwndbg` · `python` · `strings` · `objdump` · `file`
